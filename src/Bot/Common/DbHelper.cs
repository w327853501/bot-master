...
namespace Bot.Common
{
    public class DbHelper
    {
        ...
        static DbHelper()
        {
            ...
            tableTypes.Add(typeof(GoodsKnowledgeEntity));
            tableTypes.Add(typeof(RobotRuleCatalogEntity));
            tableTypes.Add(typeof(RobotRuleEntity));
            tableTypes.Add(typeof(ChatlogEntity));
