...
namespace Bot.AssistWindow.Widget.Bottom.BuyerNote
{
    public partial class WndFavoriteNoteEditor : EtWindow
    {
        ...
        private VdWndFavoriteNoteEditor _data;
        ...
        {
            InitializeComponent();
            Title = ((preFavNote == null) ? "新增【常用】顾客便签" : "编辑【常用】顾客便签");
            _data = new VdWndFavoriteNoteEditor((preFavNote != null) ? preFavNote.Note : null, this, null);
            _pre = preFavNote;
        ...
        {
            var wndFavoriteNoteEditor = ShowSameShopOneInstance(sellerMain, new Func<WndFavoriteNoteEditor>(() =>
            {
        ...
        public static void Edit(string sellerMain, FavoriteNoteEntity noteEntity, Window owner, Action onClosed)
        {
            ...
            wndFavoriteNoteEditor.FirstShow(sellerMain, owner, onClosed);
        }
        ...
        private class VdWndFavoriteNoteEditor : ViewData
        {
                ...
                : base(wnd)
            {
                Text = (txt ?? "");
                _wnd = wnd;
                SetBinding("Text", wnd.tboxContent, () =>
                {
