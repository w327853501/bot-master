...
namespace Bot.Options
{
    public partial class CtlRobotOptions : UserControl, IOptions
    {
        ...
        private string noAnswerTip = "亲,目前是机器人值班.这个问题机器人无法回答,等人工客服回来后再回复您.";
        ...
        public void RestoreDefault()
        {
            ...
            Params.Robot.SetAutoModeNoAnswerTip(_seller, noAnswerTip);
        ...
        public void Save(string seller)
        {
            ...
            var ruleIncludeExcept = Params.Robot.GetRuleIncludeExcept(_sellerMain);
        ...
        private void tboxNoAnswerTip_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            {
                string string_ = "确定要清空？\r\n\r\n若清空，找不到回复答案时，将直接跳过顾客，不会回复顾客的问题！";
                MsgBox.ShowTip(string_, (bool_0) =>
                {
                    if (!bool_0)
                    {
                        tboxNoAnswerTip.Text = noAnswerTip;
                    }
                }, null, null);
            }
        }
